...
class Hambug extends React.Component<{ hambugToggle: any; hambugState: boolean }> {
  constructor(props) {
    super(props);
    this.hambugH = this.hambugH.bind(this);
  }

  hambugH() {
    this.props.hambugToggle();
  }
  render() {
    return (
      <button
        id="hambug"
        className={`hambug_trigger ${this.props.hambugState ? "active" : ""}`}
        onClick={this.hambugH}
      >
        <span></span>
        <span></span>
        <span></span>
